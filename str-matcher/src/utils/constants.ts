// FTDNA Order маркеры (102 уникальных маркера = 111 значений с палиндромами)
// Y12 = первые 11 маркеров (12 значений)
// Y37 = первые 30 маркеров (37 значений)
// Y67 = первые 58 маркеров (67 значений)
// Y111 = все 102 маркера (111 значений)
...
// Группы маркеров для сравнения (согласно FTDNA order)
export const markerGroups = {
  12: markers.slice(0, 11),   // Y12 = первые 11 уникальных маркеров
  37: markers.slice(0, 30),   // Y37 = первые 30 уникальных маркеров
  67: markers.slice(0, 58),   // Y67 = первые 58 уникальных маркеров
  111: markers.slice(0, 102), // Y111 = все 102 уникальных маркера
  GP: [
